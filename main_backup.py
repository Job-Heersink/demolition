...
def find_position_sides(obj):
    xRot = obj.rotation_euler[0][0]
    yRot = obj.rotation_euler[0][1]
    zRot = obj.rotation_euler[0][2]
    
    xrot_matrix = Matrix(   Vector((1,0,0)),
                            Vector((0, math.cos(xRot), -math.sin(xRot))),
                            Vector((0, math.sin(xRot), math.cos(xRot))))
    yrot_matrix = Matrix(   Vector(( math.cos(yRot), 0, math.sin(yRot))),
                            Vector(( 0, 1, 0)),
                            Vector((-math.sin(yRot),0,math.cos(yRot))))
    zrot_matrix = Matrix(   Vector(( math.cos(zRot), math.sin(zRot), 0)),
                            Vector(( -math.sin(zRot), math.cos(zRot), 0)),
                            Vector((0,0,1)))
                            
    end_point1 = Vector(0,0,obj.scale[2]/2)
    end_point2 = Vector(0,0,-obj.scale[2]/2)
